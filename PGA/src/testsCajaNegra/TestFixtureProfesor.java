...
public class TestFixtureProfesor
{
    ...
    public void setUpAgregarYModif() throws Exception
    {
        ...
        this.manager.getProfesores().put(this.profesor_a.getClave().toUpperCase(), hash_a);
    }
    ...
    public void setUpBaja() throws Exception
    {
        ...
        this.manager.getProfesores().put(profesor_c.getClave().toUpperCase(), hash_c);
    ...
    public void setUpUbicar() throws Exception
    {
        ...
        this.manager.getProfesores().put(profesor_b.getClave().toUpperCase(), hash_b);
    ...
    public void setUpAgregarACursada() throws Exception
    {
        ...
        this.manager.getProfesores().put(this.profesor_a.getClave().toUpperCase(), hashProfesor_a);
        ...
        this.manager.getProfesores().put(this.profesor_b.getClave().toUpperCase(), hashProfesor_b);
