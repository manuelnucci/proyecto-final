...
public class AltaCursadaTest
{
    ...
    public void testAltaCursadaExitosa_1_1()
    {
        ...
        try
        {
            ...
            this.fixture.manager.altaCursada("Cursada Mate A 1", this.fixture.asignatura_a, "01-2017", "Lunes", "15:00", "17:00");
    ...
    public void testAltaCursadaExitosa_1_2()
    {
        ...
        {
            int size = this.fixture.manager.getCursadas().size();
            this.fixture.manager.altaCursada("C", this.fixture.asignatura_a, "01-2000", "Lunes", "00:00", "00:01");
            assertTrue("La cursada no se anadio al sistema", this.fixture.manager.getCursadas().size() == size + 1);
        } catch (HoraInvalidaException e)
        {
            fail("No tendria que haber salido por la excepcion HoraInvalidaException");
