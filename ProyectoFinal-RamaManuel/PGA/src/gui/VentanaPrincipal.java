...
public class VentanaPrincipal extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (e.getSource() == this.miAlumnoBaja)
            new AlumnoBaja(this.controlador);
        else if (e.getSource() == this.miAlumnoModificacion)
            new AlumnoModificar(this.controlador);
        else if (e.getSource() == this.miAlumnoConsulta)
            new AlumnoConsulta(this, true, this.controlador);
        else if (e.getSource() == this.miAlumnoAltaCursada)
            new AlumnoAltaACursada2(this, true, this.controlador);
        else if (e.getSource() == this.miAlumnoBajaCursada)
            new AlumnoBajaACursada(this, true, this.controlador);
        else if (e.getSource() == this.miModificarHistoria)
            new ModificaHistoriaAlumno(this.controlador);
        else if (e.getSource() == this.miProfesorAlta)
            new ProfesorAlta(this.controlador);
        else if (e.getSource() == this.miProfesorBaja)
            new ProfesorBaja(this.controlador);
        else if (e.getSource() == this.miProfesorConsulta)
            new ProfesorConsulta(this.controlador);
        else if (e.getSource() == this.miProfesorModificacion)
            new ProfesorModificacion(this.controlador);
        else if (e.getSource() == this.miProfesorAltaCursada)
            new ProfesorAltaACursada(this.controlador);
        else if (e.getSource() == this.miProfesorBajaCursada)
            new ProfesorBajaACursada(this.controlador);
        else if (e.getSource() == this.miModificarCompetencias)
            new ProfesorModificaCompetencias(this.controlador);
        else if (e.getSource() == this.miAsignaturaAlta)
            new AsignaturaAlta(this.controlador);
        else if (e.getSource() == this.miAsignaturaBaja)
            new AsignaturaBaja(this.controlador);
        else if (e.getSource() == this.miAsignaturaConsulta)
            new AsignaturaConsulta(this.controlador);
        else if (e.getSource() == this.miAsignaturaModificacion)
            new AsignaturaModificacion(this.controlador);
        else if (e.getSource() == this.miModificarCorrelativas)
            new AsignaturaModificarCorrelativas(this.controlador);
        else if (e.getSource() == this.miCursadaAlta)
            new CursadaAlta(this.controlador);
        else if (e.getSource() == this.miCursadaBaja)
            new CursadaBaja(this.controlador);
        else if (e.getSource() == this.miCursadaConsulta)
